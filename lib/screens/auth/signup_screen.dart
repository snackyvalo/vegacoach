                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      _buildSignupButton(context, auth.isLoading),
  ...
  Widget _buildHeader(BuildContext context) {
    return Column(
      children: [
        ...
        Text(
          'Create your coaching dashboard',
          style: Theme.of(context).textTheme.bodyMedium?.copyWith(
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: 'PlayerOne',
            prefixIcon: Icon(Icons.person_outline, color: Theme.of(context).colorScheme.onSurfaceVariant.withOpacity(0.7)),
          ),
        ),
      ],
    );
